...
from nets.net_utils import Conv2d_BN, BN_Conv2d, CDSM, SPPF, FFN_BN_Conv, FFN_Conv_BN, AttentionModule
...
if __name__ == "__main__":
    ...
    model = AFFT(num_classes=14, pretrained=False, backbone="resnet18")
