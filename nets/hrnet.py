...
def hrnet_classification(pretrained=False, backbone='hrnetv2_w18', in_channels=3):
    ...
    if pretrained:
        model_urls = {
            'hrnetv2_w18' : "https://github.com/bubbliiiing/hrnet-pytorch/releases/download/v1.0/hrnetv2_w18_weights_voc.pth",
            'hrnetv2_w32' : "https://github.com/bubbliiiing/hrnet-pytorch/releases/download/v1.0/hrnetv2_w32_weights_voc.pth",
        }
...
if __name__ == "__main__":
    model = HRnet(num_classes=21, backbone='hrnetv2_w18', pretrained=False, in_channels=25)
    model.eval()
